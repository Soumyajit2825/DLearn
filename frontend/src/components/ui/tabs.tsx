...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-center rounded-xl bg-zinc-100 p-1 dark:bg-zinc-800",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "data-[state=inactive]:text-zinc-500 hover:text-zinc-700 dark:data-[state=active]:bg-zinc-700 dark:data-[state=active]:text-white dark:data-[state=inactive]:text-zinc-400",
      className
    )}
    {...props}
  />
